  ...
  return (
    ...
    <div className="h-[10vh] w-[100%] bg-gray-300 flex items-center justify-between">
      ...
      <div className='flex gap-4 sm:pr-5 pr-3'>
        ...
        <a id='signup' href="/NewForm"><button className='sm:px-3 sm:py-2 px-2 py-1 rounded-[25px] bg-cyan-500 text-white hover:scale-95 hover:bg-cyan-600' >Sign up</button></a>
         {/*<GoogleSignIn/>*/}
