            ...
            <div className="flex grow flex-col max-md:max-w-full max-md:mt-8">
              ...
              <form>
                ...
                <div className="flex w-[510px] max-w-full flex-col mt-28 max-md:mt-10">
                  <button onClick={singUp} type="submit" className="text-cyan-400 text-opacity-90 text-xl font-medium tracking-wide bg-black self-stretch px-5 py-7 rounded-3xl max-md:max-w-full">
                    Create Account
                  </button>
